...
export default function CurvedSidebar({ title, subtitle, links, footerAction, activeItem, onSelectItem }) {
  ...
  return (
    <aside className={`w-full shrink-0 overflow-hidden lg:sticky lg:top-24 lg:self-start transition-[width,max-width,transform,opacity] duration-300 ease-out ${isCollapsed ? "lg:w-24" : "lg:w-72"}`}>
